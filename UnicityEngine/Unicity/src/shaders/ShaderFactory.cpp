...
namespace u_engine { namespace graphics { namespace ShaderFactory {

#if defined(UNICITY_PLATFORM_WIN32)
...
#elif defined(UNICITY_PLATFORM_WEB)

	const char* default_shader_vert =
		"attribute highp vec4 position;\n"
		"attribute highp vec2 uv;\n"
		"attribute highp UE_float tid;\n"
	...
	const char* default_shader_frag =
		...
		"void main()\n"
		"{\n"
		"	UE_float intensity = 1.0 / length(vs_position.xy - light_pos);\n"
		"	vec4 texColor = vs_color;\n"
		"	if (vs_tid > 0.0)\n"
		"	{\n"
		"		UE_int tid = UE_int(vs_tid - 0.5);\n"
		"		if (tid == 0)\n"
